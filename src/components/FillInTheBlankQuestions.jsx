...
const FillInTheBlankQuestions = ({data}) => {
    const [showAction,
    ...
    const tableRow = [
        {
            id: '1',
            number: '1',
            question: "The best place to be safe from an earthquake is Under ..... and between .....",
            answer: "The best place to be safe from an earthquake is under table and between the door" +
                    " frame",
            contract: 'Yes',
            ...
            <div className=" pb-4">
                <div className="flex justify-between items-center">
                    <span className="text-[#000] font-bold text-base w-[70%]">
                        * You Can See The List Of Fill In The Blank Questions In The Table Below
                    </span>
                    <button
                    ...
                    <table class="table-auto w-full">
                        <thead
                            ...
                            <tr
                                ...
                                < th className="text-black  text-left   md:px-4 px-4">
                                    Answer
                                </th>

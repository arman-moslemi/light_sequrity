  ...
  return (
    ...
    "/>
        ...
        <div className="w-full mb-7 px-3 mt-6 flex flex-wrap">
          ...
          <div className="flex flex-row mr-5 mb-2">
            <label className="flex">Security Room
        ...
        <button onClick={()=>addObject()} className="bg-green rounded-lg w-[160px] text-center shadow-greenShadow text-white mx-auto  mb-4 font-bold h-[40px] px-7 hover:bg-menuActive hover:text-green flex items-center justify-center md-sm:justify-center md-sm:w-[25%] sm:w-[35%] sm-xs:w-[90%]   md-sm:ml-6 sm-xs:ml-3" >

        ...
        <div className="mx-auto 2xs:mx-1 rounded-2xl  shadow-tableShadow mt-5 w-[90%] p-6 xs:px-2">
            <div className="flex justify-between items-center">
                ...
                <div className="flex sm:w-[50%] sm-xs:w-[80%] sm:flex-col sm:pr-4 2xs:pr-1">
                    ...
                    <button
                        className=" lg-md:block sm:w-[100%] mt-0 sm:ml-4 2xs:ml-1 sm:mt-3 w-max sm-xs:w-[100%] 2xs:px-1 px-4 h-[40px] rounded-lg shadow-grayShadow text-sm font-bold bg-green  text-white  hover:bg-[#008a5c] transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-100  duration-500">
                        View Mission
                    </button>
                </div>
            </div>

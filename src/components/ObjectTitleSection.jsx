...
const ObjectTitleSection = () => {
    ...
    return (
        <div className="flex justify-between items-center mt-8  mx-4">
            ...
            <button onClick={()=>setShowNewModal(true)} className="bg-green rounded-lg shadow-greenShadow text-white font-bold h-[40px] px-7 hover:bg-menuActive hover:text-green" >
                + New Object
            </button>
            {
                showNewModal ? 
